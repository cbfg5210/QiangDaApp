...
import com.hawk.qiangda.application.AppApplication;
...
public class SharedPreUtil {
	...
	private final static String SP_NAME = "HawkQiangDa";
	private final static int MODE = Context.MODE_PRIVATE;
	public static final String OBJECTID="objectId";
	public static final String NICKNAME="nickName";
	public static final String ROOMID="roomId";
	public static final String RECORDOBJECTID="recordObjectId";
	...
	public <T> boolean saveList(String key, List<T> list) {
		...
		Log.i(TAG, "saveList " + array.toString());
